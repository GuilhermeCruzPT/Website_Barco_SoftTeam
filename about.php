...
<body>
	...
	<!-- Page Top section -->
	<section class="page-top-section set-bg" data-setbg="img/fundo_site.jpg">
		<div class="container">
			<h2>About Us</h2>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="about-intro-pic">
						...
						<a href="https://www.youtube.com/watch?v=z3MQgy8xqQY" class="video-play video-popup"><i class="fa fa-play"></i></a>
					</div>
				</div>
				<div class="col-lg-6 about-intro-text">
					<p>A Soft Team foi uma equipa que foi criada na disciplina de Arquitetura de Computadores do curso de Técnico de Gestão e Programação  de Sistemas Informáticos da Escola de Serviços e Comércio do Oeste(Esco), quando nos propuseram fazer um rouver que fosse controlado por Bluetooth e a equipa é composta por 3 elementos  Ricardo Marques, Guilherme Cruz,Francisco Santos.</p>
